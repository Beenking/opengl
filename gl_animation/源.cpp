...
void reshape1(GLsizei width, GLsizei height) {  // GLsizei for non-negative integer
...
void reshape2(GLsizei width, GLsizei height) {  // GLsizei for non-negative integer
											   // Compute aspect ratio of the new window
	if (height == 0) height = 1;                // To prevent divide by 0
	GLfloat aspect = (GLfloat)width / (GLfloat)height;
...
int main(int argc, char** argv) {
	...
	glutReshapeFunc(reshape2);       // Register callback handler for window re-size event
